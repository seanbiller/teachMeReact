      ...
      <div id="jsx">
        <Container>
          ...
          <Row className="p-3">
            <Col lg={10}>
              <p>
                ...
                elements in JavaScript and place them in the DOM without any{" "}
                <code>createElement()</code> or <code>appendChild()</code>{" "}
                methods. It makes writing HTML in React so much cleaner. The
                Code below is an example of some basic JSX.
              </p>
            </Col>
          </Row>
          <Row className="p-3">
          ...
          <Row className="p-3">
            <Col lg={10}>
              <p>
                Now thanks to Babel which transpiles JSX into valid JavaScript
                for us we can write HTML in JavaScript in a much shorter and
                cleaner format. If we didn't have Babel and had to write all
                this out ourselves then the code would look like this.
              </p>
            </Col>
          </Row>
          <Row className="p-3">
          ...
          <Row className="p-3">
            <Col lg={10}>
              <p>
                ...
                JSX we have to use <code>createElement()</code> everytime we
                want to create a use an HTML tag. JSX makes our lives so much
                easier, you can test out your own JSX code and see what it would
                look like in plain Javascript over on Babels website.{" "}
                <a
                  target="_black"
                ...
                One thing to always remember with JSX is that you must always
                wrap adjacent JSX elements in an enclosing tag.
              </p>
            </Col>
          </Row>
          <Row className="p-3">
          ...
          <Row className="p-3">
            <Col lg={10}>
              ...
              <Alert variant="danger">
                SyntaxError: Adjacent JSX elements must be wrapped in an
                enclosing tag. Did you want a JSX fragment <>...</>? (10:6)
              </Alert>
            </Col>
          </Row>
          <Row className="p-3">
            <Col lg={10}>
              <p>
                ...
                extra nodes to the DOM. What does that mean? It means it tells
                the DOM that its child elements are grouped, but unlike the div
                tag it is completly ignored otherwise. The div tag will appear
                in the DOM, the React.Fragment won't.
              </p>
            </Col>
          </Row>
          <Row className="p-3">
